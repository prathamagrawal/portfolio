            ...
            <Grid spacing-12 item xs={12} sm={12} md={6}>
              ...
              >
                <div className="card_de">
                  ...
                  <p>
                    Developing optimised Machine Learning and Deep learning
                    algoritms to better solve the problems existing in real
                    life. I use Python, Tensorflow, and Pytorch for the same.{' '}
                  </p>
                </div>
              </Paper>
            </Grid>
            <Grid spacing-12 item xs={12} sm={12} md={6}>
              ...
              >
                <div className="card_de">
                  ...
                  <p>
                    Analyze, process, and model data that can be used to
                    building Machine Learning algorithms, or data
                    visualizations. Able to convert the messy, unstructured data
                    to processed Structured Data.
                  </p>
                </div>
              </Paper>
            </Grid>
